...
public class ArrayDeque<T> {
    ...
    public ArrayDeque(StaticEndlessLinkedList<T> linkedList) {
        if (linkedList == null) {
            ...
            for(int i = 0; i < linkedList.size(); ++i) {
                this.backingArray[i] = linkedListIterator.next();
            }
    ...
    public void addFirst(T data) {
        if (data == null) {
            ...
            if (this.size == this.backingArray.length) {
                Object[] newArray = new Object[this.backingArray.length * 2];
    ...
    public void addLast(T data) {
        if (data == null) {
            ...
            if (this.size == this.backingArray.length) {
                ...
                int newIndex = mod(this.front + this.size, this.backingArray.length);
                this.backingArray[newIndex] = data;
            }
    ...
    public T removeFirst() {
        if (this.size == 0) {
            ...
            T value = (T)this.backingArray[this.front];
    ...
    public T removeLast() {
        if (this.size == 0) {
            ...
            int last = mod(this.front + this.size - 1, this.backingArray.length);
            T value = (T)this.backingArray[last];
            this.backingArray[last] = null;
            --this.size;
            return value;
        }
    }
    ...
    public T getFirst() {
        if (this.size == 0) {
            ...
            return (T) this.backingArray[this.front];
        }
    }
